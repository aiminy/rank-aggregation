...
sgdPL2 = function(data, mu, sigma, rate, maxiter = 1000, tol = 1e-9, start){
  ...
  while(flag){
    ...
    for(i in 1:nobs){
      ...
      res_temp = targetPL2(score_temp, adherence_temp, data, mu, sigma)
...
res = sgdPL2(data, sigma = diag(rep(1, 99)), rate = 0.1, 
